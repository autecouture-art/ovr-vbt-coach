...
| 2026-04-15-03 | graph | グラフモードで各種目の日毎の e1RM 推移を見れるようにする | implemented | medium | codex | app/(tabs)/graph.tsx | untested | 実機で視認性確認待ち | 直近30セッションから選択種目のセットを集計し、日次の最高 e1RM を進捗タブへ表示 |
